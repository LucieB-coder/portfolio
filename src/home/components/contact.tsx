    ...
    return (
        <div className="flex flex-1 flex-col md:flex-row items-center space-y-8 md:min-h-screen justify-around py-12 bg-background-700">
            ...
            <div className="flex flex-col items-center gap-5">
                ...
                <a href={"tel:+33767447587"} className="md:text-xl">+33 7 67 44 75 87</a>

                <a href={"mailto:lucie.bedouret.work@gmail.com"} className="md:text-xl">lucie.bedouret.work@gmail.com</a>
            </div>
        </div>
    );
}