...
import filsPhoto from "../assets/fils.jpg";
            ...
            <div className="px-5 md:px-12 lg:px-26 xl:px-32">
                <div className="flex flex-col md:flex-row rounded-3xl p-12 space-y-12 md:space-x-12 justify-center items-center md:py-32">
                    ...
                    <div className="h-64 xl:h-72 aspect-square bg-primary-600 rounded-3xl" >
                        <img className="object-cover overflow-hidden h-64 xl:h-72 bg-primary-600 rounded-3xl" src={me} alt="me" />
                    </div>
                </div>

                <div className="flex flex-col rounded-3xl px-5 space-y-12 justify-center items-center">
                    ...
                    <div className="flex flex-col md:flex-row space-y-5 md:space-x-10 justify-center items-center">
                        <p className="flex flex-1 text-md md:text-lg text-center md:text-start">{"Outside of my interests in development and current technologies, I have many hobbies. I love to read, play video games (I am a huge fan of the Diablo series), and I am very curious about anything related to astrophysics. I also love plants, and much more. For the past year, I’ve been teaching myself to play chess. There is still a long road ahead, but I am slowly becoming a challenging opponent. If you dare, click on the button and confront me for a game on Chess.com!"}</p>
                        <a href="https://www.chess.com/member/lulu-la-tortue" className="flex flex-1 flex-no-wrap items-center space-x-3">
